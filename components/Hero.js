...
export default function Hero() {
  return (
    <div class=" sm:mx-auto lg:px-12">
     
      <div class="mx-auto max-w-2xl lg:max-w-5xl">
      
        <div class=" px -30 mx-auto prose max-w-2xl">
          <h1 class="text-4xl gradient-to-r from-indigo-500 via-purple-500 to-pink-500 font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Software Developer, UX Researcher, and a Musicphile.
          </h1>
          <div class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            <span className="text-xl pb-0 ">I’m Collins , C#(ASP.NET), node js  Developer and  designer  adept at contributing to highly collaborative work environment, finding solutions and determining customer satisfaction. </span>
            <br/>
            <br/>
            <br/>
            <p className=" pt-5px text-italics">Based in Nakuru, Kenya</p>
