...
export default function portfolio({siteconfig})
{
  return (
    <Layout {...siteconfig}>
      <Container className="min-h-screen">
        ...
        <div className=" px -30 mx-auto prose max-w-2xl">
          ...
          <div className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            <span classNameName="text-xl pb-0 ">I’m Collins , C#(ASP.NET), node js  Developer and  designer  adept at contributing to highly collaborative work environment, finding solutions and determining customer satisfaction. </span>
            <br/>
            <br/>
            <br/>
